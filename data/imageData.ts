export type Image = {
  ...
  export const images: Image[] = [
    ...
    { src: '/images/takurTulungTumpuk.JPG', alt: 'Takur Tulung Tumpuk', title: 'Takur Tulung Tumpuk', subtitle:'Megalaima javensis', description: 'Spesies yang hanya ditemukan di pulau Jawa dan Bali ini ter-ancam punah akibat hilangnya habitat. Mereka tinggal di hutan dataran rendah subtropis atau tropis yang lembab serta di pegunungan yang lembab.' },
    ...
    { src: '/images/lutungJawa.JPG', alt: 'Lutung Jawa', title: 'Lutung Jawa', subtitle: 'Trachypithecus auratus', description: 'Populasi spesies ini menurun akibat peng-gundulan hutan, per-buruan, dan perdagangan ilegal. Kepadatan pen-duduk di Jawa berakibat pada banyaknya hutan ditebangi untuk dijadikan permukiman dan pertanian.' },
